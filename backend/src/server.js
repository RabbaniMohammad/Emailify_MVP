...
const templateGeneration_1 = __importDefault(require("@src/routes/templateGeneration")); // ✅ NEW
const debug_logs_1 = __importDefault(require("@src/routes/debug-logs")); // Debug logging endpoint
