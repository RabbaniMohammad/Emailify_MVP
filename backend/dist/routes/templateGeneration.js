...
router.post('/chat', auth_1.authenticate, organizationContext_1.organizationContext, async (req, res) => {
    try {
        ...
        if (currentMjml) {
            ...
            result = await (0, templateGenerationService_1.refineTemplate)(currentMjml, message.trim(), conversationHistory, // ✅ Full history from frontend
            userId, images || undefined, extractedFileData || undefined);
        }
        else {
