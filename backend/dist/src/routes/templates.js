...
router.post('/', auth_1.authenticate, organizationContext_1.organizationContext, async (req, res) => {
    try {
        const { name, content, html: contentHtml, templateName, type: payloadType, category, createdBy: payloadCreatedBy, createdDate, lastEdited, active, dragDrop, responsive, folderId, source, } = req.body;
