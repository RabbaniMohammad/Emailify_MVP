...
const templateGeneration_1 = __importDefault(require("./routes/templateGeneration")); // ✅ NEW
const debug_logs_1 = __importDefault(require("./routes/debug-logs")); // Debug logging endpoint
const websiteAnalyzer_1 = __importDefault(require("./routes/websiteAnalyzer")); // ✅ Website Analyzer
...
app.use('/api', websiteAnalyzer_1.default);
// Core API routers
